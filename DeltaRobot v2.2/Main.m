...
while true
    ...
    switch comm
            ...
            case 'g'
                path(:,:,1) = [ 0    0   -150]; path(:,:,2) = [-100 -100 -150]; path(:,:,3) = [-100 -100 -200];
                path(:,:,4) = [-100 -100 -150]; path(:,:,5) = [-100  100 -150]; path(:,:,6) = [-100  100 -200];
                path(:,:,7) = [-100  100 -150]; path(:,:,8) = [ 100 -100 -150]; path(:,:,9) = [ 100 -100 -200];
                path(:,:,10) = [100 -100 -150]; path(:,:,11) = [100  100 -150]; path(:,:,12) = [100  100 -200];
                path(:,:,13) = [100  100 -150]; path(:,:,14) = [0 0 Z];
                skip = true;
                tally = tally + 1;
                disp(tally);
                X = path(1, 1, tally);
